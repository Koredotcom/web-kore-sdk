...
```bash
npm install --save git+https://github.com:Koredotcom/web-kore-sdk.git#v2/9.3.11
```
...
<script  src="https://cdn.jsdelivr.net/gh/Koredotcom/web-kore-sdk@v2-9.3.11/dist/umd/kore-web-sdk-umd-chat.min.js"></script>
<script>
