    ...
    config = {
        ...
        languageStrings: {   //any additional language can be added in this object by adding the key in availableLanguages
            ar: {
                ...
                media: "وسائط",
                file: "ملف",
                dragAndDropFile: "اسحب الملف وأفلته هنا للتحميل",
            ...
            ja: {
                ...
                media: 'メディア',
                file: 'ファイル',
                dragAndDropFile: 'ドラッグ＆ドロップしてファイルをアップロード',
            ...
            ko: {
                ...
                media: '미디어',
                file: '파일',
                dragAndDropFile: '파일을 여기에 끌어다 놓아 업로드',
            ...
            de: {
                ...
                media: "Medien",
                file: "Datei",
                dragAndDropFile: "Datei zum Hochladen hierher ziehen und ablegen",
