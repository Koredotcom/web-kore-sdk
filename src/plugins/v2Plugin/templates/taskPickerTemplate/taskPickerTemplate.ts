...
class TaskPickerTemplate {
    ...
    getTemplateString() {
    let headerTemplate= '<script id="v2_chat_taskpickeerHeader" type="text/x-jqury-tmpl"> \
    ...
    getTaskPickerOptionsTemplate(){
        let me: any = this;
        let $ = me.hostInstance.$;
        var taskPickerTemplate = '<script id="v2_chat_taskpickeroptions" type="text/x-jqury-tmpl"> \
