...
class C2C {
    c2c_phone = new AudioCodesUA(); // phone API
    c2c_audioPlayer = new AudioPlayer();
    c2c_activeCall = null; // not null, if exists active call
    c2c_restoreCall = null;
    c2c_sbcDisconnectCounter = 0;
    c2c_sbcDisconnectCounterMax = 5;
    c2c_messageId = 0;
    ...
    c2c_searchServerAddress = function (addresses, searchAddress) {
    ...
    c2c_setButtonForHangup = function (changeSVG = true) {
        let button = document.getElementById('c2c_button');
    ...
    c2c_setButtonForCalling = function () {
        let button = document.getElementById('c2c_button');
        button.onclick = () => {
    ...
    c2c_info = function (text, clear = false) {
    ...
    c2c_makeCall = function (callTo, videoMode, extraHeaders = null) {
        if (c2c_activeCall !== null)
