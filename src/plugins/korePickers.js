...
class KorePickersPlugin {
    ...
    constructor(pickerConfig) {
        this.config = pickerConfig;// spread operator
    }
    onChatWindowInit() {
        this.onInit();
    }
    onInit() {
        let me = this;
        let $ = me.cwInstance.$;
        if (me.cwInstance && me.cwInstance.config && me.cwInstance.config.pickersConfig) {
            this.config = me.cwInstance.config.pickersConfig;
        }
    ...
    appendPickersToChatWindow() {
        ...
        } else if (this.config && this.config.showDatePickerIcon) {
            me.pickerHTML = $(me.getDatePickerTemplateString());
        }
        else if (this.config && this.config.showDateRangePickerIcon) {
            me.pickerHTML = $(me.getDateRangePickerTemplateString());
        }
        else if (this.config && this.config.showTaskMenuPickerIcon) {
            me.pickerHTML = $(me.getTaskPickerTemplateString());
        }
        else if (this.config && this.config.showradioOptionMenuPickerIcon) {
    ...
    bindEvents() {
        ...
        let $ = me.cwInstance.$;
        let chatWindowInstance = me.cwInstance;
        $(me.pickerHTML).on('click', '.sdkClock.clockBtn', function (event) {
            var tempMessageData = {
                message: [
                    {
                        component: {
        ...
        $(me.pickerHTML).on('click', '.sdkCalender.calenderBtn', function (event) {
            var tempMessageData = {
                message: [
                    {
                        component: {
        ...
        $(me.pickerHTML).on('click', '.sdkRangeCalender.calenderBtn', function (event) {
            var tempMessageData = {
                message: [
                    {
                        component: {
        ...
        $(me.pickerHTML).on('click', '.sdkAccount.accountBtn', function (event) {
            var tempMessageData = {
                message: [
                    {
                        component: {
        ...
        $(me.pickerHTML).on('click', '.sdkMenu.menuBtn', function (event) {
            var tempMessageData = {
                message: [
                    {
                        component: {
