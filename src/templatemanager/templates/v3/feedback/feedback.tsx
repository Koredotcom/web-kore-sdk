            ...
            <div className="feedback-temp-wrapper">
                <div className="feedback-temp-sec">
                    ...
                    {msgData.message[0].component.payload.view == 'ThumbsUpDown' && <div className="thumbs-up-down-feebdack">
                        <button className="btn-thumb-fdb negtive-thumb" onClick={event => handleThumps(event, 'negative', msgData.message[0].component.payload.thumpsUpDownArrays[0])}>
                        ...
                        <button className="btn-thumb-fdb positive-thumb" onClick={event => handleThumps(event, 'positive', msgData.message[0].component.payload.thumpsUpDownArrays[1])}>
                            ...
                            <span>{msgData.message[0].component.payload.thumpsUpDownArrays[1].reviewText}</span>
                        </button>
                    </div>}
