...
export function RetailOrderSelection(props: any) {
    ...
    useEffect(() => {
        const wrappers = document.querySelectorAll('.card-template-wrapper');
        const lastWrapper = wrappers[wrappers.length - 1] as HTMLElement;
        if (lastWrapper && lastWrapper.classList.contains('card-template-wrapper')) {
                                    ...
                                    <div className="left-section">
                                        {
                                            ele.checkBox === "enabled" && (
                                                <div class="kr-sg-checkbox">
                                                    ...
                                                    {/* <label for="checkbox-1" class="checkbox-custom-label">Checkbox item</label> */}
                                                </div>
                                            )}
