                                        ...
                                        <div className="checkbox-list-data-tems">
                                            ...
                                            {item.optionsData[0].type === 'radio' && item.optionsData.map((radioEle: any, ind: any) => (
                                                <div className="radio-button-item">
                                                    <input id={`radio-button-${msgData.messageId}-${index}-${ind}`} name={`radio-btn-${msgData.messageId}-${index}`} className="radio-input" type="radio" value={radioEle.value} label={radioEle.label} data-kr-alt-rad={`${msgData.messageId}_${index}`} onKeyDown={(e) => { if (e.key === 'Enter') onSubmit(item, index); }} />
