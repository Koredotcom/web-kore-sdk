    ...
    return (
        <div className="chat-widget-composebar" aria-label="chat widget compose">
            ...
            <div className={inputTypeObj[brandingInfo.footer.layout]} aria-label="compose footer">
                ...
                { brandingInfo.footer.buttons.attachment.show && <button className="action-btn connect-to-agent" type="button" title={hostInstance.config.botMessages.attachments} onClick={() => checkForFileUploadPlugin()}>
