...
export function ChatWidgetComposeBar(props: any) {
    ...
    return (
        <div className="chat-widget-composebar" aria-label="chat widget compose">
            ...
            <div className="attachment-wrapper-data hide-attachment kwsdk-bg-secondary kwsdk-pt-4 kwsdk-px-4">
                <div className="attachment-upload-card kwsdk-d-flex kwsdk-position-relative kwsdk-flex-column kwsdk-align-items-center kwsdk-gap-4 kwsdk-w-100 kwsdk-py-4 kwsdk-px-6 kwsdk-bg-white kwsdk-border kwsdk-rounded-4">
                    <div className="drag-drop-upload kwsdk-d-flex kwsdk-position-relative kwsdk-z-20 kwsdk-flex-column kwsdk-align-items-center kwsdk-gap-3 kwsdk-w-100 kwsdk-p-0 kwsdk-text-primary kwsdk-pe-none" aria-hidden="true">
                        <div className="drag-drop-upload-icon kwsdk-size-40 kwsdk-d-flex kwsdk-align-items-center kwsdk-justify-content-center kwsdk-border kwsdk-rounded-3"><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><path d="M13.3333 13.3333L10 10L6.66667 13.3333M10 10V17.5M16.6667 13.9524C17.6846 13.1117 18.3333 11.8399 18.3333 10.4167C18.3333 7.88536 16.2813 5.83333 13.75 5.83333C13.5679 5.83333 13.3975 5.73833 13.3051 5.58145C12.2184 3.73736 10.212 2.5 7.91667 2.5C4.46489 2.5 1.66667 5.29822 1.66667 8.75C1.66667 10.4718 2.36287 12.0309 3.48912 13.1613" stroke="currentColor" strokeWidth="1.66667" strokeLinecap="round" strokeLinejoin="round"/></svg></div>
                        <p className="kwsdk-text-sm kwsdk-fw-medium">{hostInstance.config.botMessages.dragAndDropFile}</p>
                    </div>
                        <div className="drag-file-pointer kwsdk-position-fixed kwsdk-z-1000 kwsdk-size-20 kwsdk-pe-none" aria-hidden="true">
                            <svg width="18" height="17" viewBox="0 0 18 17" fill="none" className="drag-file-cursor kwsdk-position-absolute kwsdk-top-0 kwsdk-start-0">
                                <g filter="url(#filter0_d_7111_2)">
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M5.04773 2.22282C5.53498 2.03746 6.49629 2.15096 6.75006 2.71538C6.96628 3.19649 7.15204 4.0077 7.1622 3.83484C7.18656 3.45058 7.13783 2.61957 7.30127 2.18533C7.42003 1.86876 7.65351 1.57093 7.99763 1.46575C8.28693 1.37619 8.62699 1.34495 8.92746 1.40848C9.24519 1.47512 9.57916 1.70735 9.70402 1.92811C10.0715 2.57688 10.0776 3.90565 10.0948 3.83484C10.1598 3.55159 10.1659 2.55501 10.3821 2.18533C10.5252 1.94061 10.8866 1.72192 11.0795 1.68652C11.3779 1.63237 11.7454 1.61571 12.058 1.67819C12.3108 1.72921 12.6529 2.03641 12.7453 2.18533C12.9676 2.54356 13.0924 3.55575 13.13 3.9119C13.1462 4.05873 13.2051 3.50265 13.4274 3.14546C13.8396 2.48003 15.2993 2.3509 15.3541 3.81089C15.3805 4.49193 15.3744 4.46069 15.3744 4.91889C15.3744 5.45623 15.3622 5.78113 15.3338 6.1706C15.3033 6.5861 15.216 7.52853 15.0892 7.98465C15.0019 8.29809 14.7125 9.00309 14.4263 9.42588C14.4263 9.42588 13.3361 10.7276 13.2173 11.3128C13.0985 11.8991 13.1381 11.9033 13.1138 12.3177C13.0904 12.7332 13.2366 13.2789 13.2366 13.2789C13.2366 13.2789 12.4235 13.3872 11.9839 13.3143C11.587 13.2497 11.0957 12.4396 10.9688 12.1917C10.7942 11.8502 10.4217 11.9158 10.2765 12.1678C10.0492 12.5666 9.55683 13.282 9.21068 13.3268C8.53157 13.4143 7.12464 13.358 6.02325 13.3476C6.02325 13.3476 6.21104 12.2948 5.79282 11.9335C5.48321 11.6627 4.95028 11.117 4.63154 10.8296L3.78697 9.87054C3.4997 9.49565 2.76984 8.90312 2.5252 7.80345C2.30898 6.82874 2.3303 6.35076 2.56276 5.96025C2.79826 5.56349 3.24288 5.34689 3.42966 5.3094C3.6408 5.26566 4.13211 5.26879 4.31787 5.37396C4.54424 5.50205 4.6356 5.53954 4.81324 5.78113C5.04672 6.10083 5.12996 6.25599 5.02946 5.90714C4.95231 5.6343 4.7026 5.28753 4.58891 4.89702C4.47826 4.52109 4.18185 3.91502 4.20317 3.30791C4.21129 3.07777 4.30772 2.50503 5.04773 2.22282Z" fill="white"/>
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M5.04773 2.22282C5.53498 2.03746 6.49629 2.15096 6.75006 2.71538C6.96628 3.19649 7.15204 4.0077 7.1622 3.83484C7.18656 3.45058 7.13783 2.61957 7.30127 2.18533C7.42003 1.86876 7.65351 1.57093 7.99763 1.46575C8.28693 1.37619 8.62699 1.34495 8.92746 1.40848C9.24519 1.47512 9.57916 1.70735 9.70402 1.92811C10.0715 2.57688 10.0776 3.90565 10.0948 3.83484C10.1598 3.55159 10.1659 2.55501 10.3821 2.18533C10.5252 1.94061 10.8866 1.72192 11.0795 1.68652C11.3779 1.63237 11.7454 1.61571 12.058 1.67819C12.3108 1.72921 12.6529 2.03641 12.7453 2.18533C12.9676 2.54356 13.0924 3.55575 13.13 3.9119C13.1462 4.05873 13.2051 3.50265 13.4274 3.14546C13.8396 2.48003 15.2993 2.3509 15.3541 3.81089C15.3805 4.49193 15.3744 4.46069 15.3744 4.91889C15.3744 5.45623 15.3622 5.78113 15.3338 6.1706C15.3033 6.5861 15.216 7.52853 15.0892 7.98465C15.0019 8.29809 14.7125 9.00309 14.4263 9.42588C14.4263 9.42588 13.3361 10.7276 13.2173 11.3128C13.0985 11.8991 13.1381 11.9033 13.1138 12.3177C13.0904 12.7332 13.2366 13.2789 13.2366 13.2789C13.2366 13.2789 12.4235 13.3872 11.9839 13.3143C11.587 13.2497 11.0957 12.4396 10.9688 12.1917C10.7942 11.8502 10.4217 11.9158 10.2765 12.1678C10.0492 12.5666 9.55683 13.282 9.21068 13.3268C8.53157 13.4143 7.12464 13.358 6.02325 13.3476C6.02325 13.3476 6.21104 12.2948 5.79282 11.9335C5.48321 11.6627 4.95028 11.117 4.63154 10.8296L3.78697 9.87054C3.4997 9.49565 2.76984 8.90312 2.5252 7.80345C2.30898 6.82874 2.3303 6.35076 2.56276 5.96025C2.79826 5.56349 3.24288 5.34689 3.42966 5.3094C3.6408 5.26566 4.13211 5.26879 4.31787 5.37396C4.54424 5.50205 4.6356 5.53954 4.81324 5.78113C5.04672 6.10083 5.12996 6.25599 5.02946 5.90714C4.95231 5.6343 4.7026 5.28753 4.58891 4.89702C4.47826 4.52109 4.18185 3.91502 4.20317 3.30791C4.21129 3.07777 4.30772 2.50503 5.04773 2.22282Z" stroke="black" stroke-width="0.75" stroke-linecap="round" stroke-linejoin="round"/>
                                </g>
                                <defs>
                                    <filter id="filter0_d_7111_2" x="0" y="0" width="17.75" height="16.75" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
                                    ...
                                    <feBlend mode="normal" in2="BackgroundImageFix" result="effect1_dropShadow_7111_2"/>
                                    <feBlend mode="normal" in="SourceGraphic" in2="effect1_dropShadow_7111_2" result="shape"/>
                                    </filter>
                                </defs>
                            </svg>
                        </div>
                <div className="select-file-block kwsdk-bg-transparent kwsdk-rounded-0 kwsdk-p-0 kwsdk-d-flex kwsdk-align-items-center kwsdk-gap-3 kwsdk-w-100">
                    <button className="inputfile-btn inputfile-btn-media kwsdk-position-relative kwsdk-d-flex kwsdk-align-items-center kwsdk-justify-content-center kwsdk-bg-button kwsdk-rounded-3" type="button" aria-label="Media">
                    ...
                    <button className="inputfile-btn inputfile-btn-file kwsdk-position-relative kwsdk-d-flex kwsdk-align-items-center kwsdk-justify-content-center kwsdk-bg-button kwsdk-rounded-3" type="button" aria-label="File">
                        <svg width="21" height="20" viewBox="0 0 21 20" fill="none">
                ...
                <div className="uploaded-attachment-data kwsdk-mt-2">
