        ...
        <div className="chat-widget-composebar" aria-label="chat widget compose">
            ...
            <div className="attachment-wrapper-data hide-attachment kwsdk-bg-secondary kwsdk-pt-4 kwsdk-px-4">
                ...
                <div className="select-file-block kwsdk-bg-transparent kwsdk-rounded-0 kwsdk-p-0 kwsdk-d-flex kwsdk-align-items-center kwsdk-gap-3 kwsdk-w-100">
                    <button className="inputfile-btn inputfile-btn-media kwsdk-position-relative kwsdk-d-flex kwsdk-align-items-center kwsdk-justify-content-center kwsdk-bg-brand kwsdk-rounded-3" type="button" aria-label="Media">
                    ...
                    <button className="inputfile-btn inputfile-btn-file kwsdk-position-relative kwsdk-d-flex kwsdk-align-items-center kwsdk-justify-content-center kwsdk-bg-brand kwsdk-rounded-3" type="button" aria-label="File">
                        <svg width="21" height="20" viewBox="0 0 21 20" fill="none">
