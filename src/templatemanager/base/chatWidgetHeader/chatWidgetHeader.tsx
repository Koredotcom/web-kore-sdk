...
export function ChatWidgetHeader(props: any) {
    ...
    const handleAgentOption = (action: string) => {
        ...
        if (action === 'call') {
            handleHeaderIcon('Call to Agent');
        } else if (action === 'chat') {
        ...
        <div className={hSizeObj[brandingInfo.header.size]} aria-label="chat widget header">
            ...
            <div className="actions-info">
               { brandingInfo.header.buttons.help.show && <a title={hostInstance.config.botMessages.help} href={brandingInfo.header.buttons.help.action.value} target="_blank" className="btn-action link-url">
                ...
                { brandingInfo.header.buttons.reconnect.show && <button title={hostInstance.config.botMessages.reconnect} id="kore-reconnect-btn" className="btn-action btn-reconnect" type="button">
                ...
                { brandingInfo.header.buttons.live_agent.show && <div className="agent-dropdown-wrapper">
                    ...
                    {showAgentDropdown && (
                        <div className="agent-dropdown">
                            <button onClick={() => handleAgentOption('call')}>Call to Agent</button>
                            <button onClick={() => handleAgentOption('chat')}>Chat With Agent</button>
                        </div>
                    )}
                </div>}
