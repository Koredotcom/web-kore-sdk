...
class DateRangePickerTemplate {
    ...
    bindDataToTemplate(msgData: any) {
        ...
        $(me.messageHtml).find(".kore-action-sheet .dateRangePickerContainer .date-picker-wrapper .month-wrapper .real-today").addClass("first-date-selected");
        $(me.messageHtml).find(".kore-action-sheet .dateRangePickerContainer .date-picker-wrapper .month-wrapper .real-today.first-date-selected").trigger("click");
