const RetailBrandingJSON = {
    ...
    welcome_screen: {
        ...
        logo: {
            logo_url:
                'https://dev-xo.kore.ai:443/api/getMediaStream/orgFiles/o-2f31e9d4-dc92-5eaa-acd1-80cc1bd6428b/f-f37b5ada-6cc4-5008-a048-537dd7eb0677.png?n=1653037983&s=IkFSZWs3TTRKbnc0MmVQdzU4S2doR3lpeS9ZQUhxR2hic1ZlL21iVHdwazg9Ig$$',
            name: 'kore.ai',
        },
        title: {
            name: 'Hello',
            ...
            links: [
                {
                    title: 'Community',
                    description:
                        'The US mobile number comes with two sims cards meant for GSM & LTE',
                    action: {
                        type: 'url',
                        value: 'https://kore.ai/',
                    },
