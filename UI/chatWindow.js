...
var iframe = '<script id="chat_message_tmpl" type="text/x-jquery-tmpl"> \
    ...
    //  return {
    //      initToken: chatWindow.initToken,
    //      addListener: chatWindow.addListener,
    //      removeListener: chatWindow.removeListener,
    //      show: chatWindow.show,
    //      destroy: chatWindow.destroy,
    //      showError: chatWindow.showError,
    //      botDetails: chatWindow.botDetails,
    //      chatHistory: chatWindow.chatHistory,
    //      getSDKInstance:function(){
    //          return bot;
    //      },
    //      instance:chatWindow.chatInitialize,
    //      sdkInstance:bot,
    //      chatWindow:chatWindow,
    //      addWidgetEvents:chatWindow.addWidgetEvents,
    //      setWidgetInstance:chatWindow.setWidgetInstance,
    //      closeConversationSession:chatWindow.closeConversationSession
    //  };
