(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["KorePickersPluginSDK"] = factory();
	else
		root["KorePickersPluginSDK"] = factory();
})(self, () => {
...
var ___CSS_LOADER_URL_IMPORT_0___ = new URL(/* asset import */ __webpack_require__(3904), __webpack_require__.b);
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
var ___CSS_LOADER_URL_REPLACEMENT_0___ = _node_modules_css_loader_dist_runtime_getUrl_js__WEBPACK_IMPORTED_MODULE_2___default()(___CSS_LOADER_URL_IMPORT_0___);
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".clockPickerContainer .sdkFooterIcon.clock{opacity:0}.kore-chat-window .sdkFooterIcon.clock .sdkClock.clockBtn .clock{background-image:url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ");background-size:100% 100%;width:21px;height:21px;margin:-4px;display:block}.clockPickerContainer .clockpicker-popover{width:100%;position:relative;top:auto;left:auto;margin:0 auto;border:0;background:rgba(0,0,0,0);max-width:100%;box-shadow:none}.clockPickerContainer .clockpicker-popover .arrow{display:none}.clockPickerContainer .clockpicker-popover .popover-title{height:84px;background-color:#f2f3f5;padding:26px 70px 26px 26px;font-size:54px;border:0}.clockPickerContainer .clockpicker-popover .popover-title span.clockpicker-span-hours{font-size:54px;color:#000;opacity:.3}.clockPickerContainer .clockpicker-popover .popover-title .clockpicker-span-hours.text-primary{opacity:1}.clockPickerContainer .clockpicker-popover .popover-title .clockpicker-span-minutes.text-primary{opacity:1}.clockPickerContainer .clockpicker-popover .popover-title span.clockpicker-span-minutes{font-size:54px;color:#000;opacity:.3}.darkTheme .clockPickerContainer .clockpicker-popover .popover-title{height:84px;background-color:#2e2c34;padding:26px 70px 26px 26px;font-size:54px}.darkTheme .clockPickerContainer .clockpicker-popover .popover-title span.clockpicker-span-hours{font-size:54px;color:#fff}.darkTheme .clockPickerContainer .clockpicker-popover .popover-title span.clockpicker-span-minutes{font-size:54px;color:#fff}.hide .clockPickerContainer .confirmBTN{opacity:0}.clockPickerContainer .confirmBTN{position:absolute;height:54px;background:#009dab;bottom:0;width:100%;text-align:center;cursor:pointer;font-size:16px;font-weight:500;color:#fff;opacity:1;line-height:54px;transition:opacity 1.5s ease-in-out;-moz-transition:opacity 1.5s ease-in-out;-webkit-transition:opacity 1.5s ease-in-out}.darkTheme .clockPickerContainer .confirmBTN{background:#0047cc}.clockPickerContainer .headerClock{height:56px;padding:17px;position:relative}.clockPickerContainer .headerClock .choose{font-size:20px;font-weight:bold;color:#000}.clockPickerContainer .headerClock .closeButton{cursor:pointer;color:#aaa;background:none;border:none;opacity:1;outline:none;font-size:30px;float:right;line-height:inherit;margin-top:5px;padding:0 6px;position:absolute;right:10px;top:5px}.clockPickerContainer .clockpicker-popover .clockpicker-button.am-button,.clockPickerContainer .clockpicker-popover .clockpicker-button.pm-button{margin-left:0;padding:3px;border:0;border-radius:4px;display:flex;background:rgba(0,0,0,0);color:#000}.darkTheme.kore-chat-window .clockPickerContainer .clockpicker-popover .clockpicker-button.am-button,.darkTheme.kore-chat-window .clockPickerContainer .clockpicker-popover .clockpicker-button.pm-button{color:#fff}.clockPickerContainer .clockpicker-popover .clockpicker-am-pm-block{right:0;position:absolute;top:0;width:60%;display:flex;flex-direction:column;align-items:center;justify-content:center;padding:20px}.clockPickerContainer{padding-bottom:54px;position:relative}.clockPickerContainer .clockpicker-popover .clockpicker-span-am-pm{display:none}.clockPickerContainer .clockpicker-popover .popover-content{background-color:rgba(0,0,0,0)}.clockPickerContainer .clockpicker-popover .popover-content .clockpicker-plate{width:196px;height:196px;margin:0 auto;background-color:#eee;border:1px solid #eee}.clockPickerContainer #clockPickerInput .hide{display:none}.darkTheme .clockPickerContainer .clockpicker-popover .popover-content .clockpicker-plate{background-color:#2e2c34;border:1px solid #2e2c34}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
var ___CSS_LOADER_URL_IMPORT_0___ = new URL(/* asset import */ __webpack_require__(7197), __webpack_require__.b);
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
var ___CSS_LOADER_URL_REPLACEMENT_0___ = _node_modules_css_loader_dist_runtime_getUrl_js__WEBPACK_IMPORTED_MODULE_2___default()(___CSS_LOADER_URL_IMPORT_0___);
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".datePickerContainer .sdkFooterIcon.calender{opacity:0}.kore-chat-window .sdkFooterIcon.singleCalender .sdkCalender.calenderBtn .calender{background-image:url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ");background-size:100% 100%;width:21px;height:21px;margin:-4px;display:block}.datePickerContainer .close-button{cursor:pointer;color:#aaa;background:none;border:none;opacity:1;outline:none;font-size:30px;float:right;line-height:inherit;margin-right:30px;margin-top:5px;padding:0 6px}.datePickerContainer .date-picker-wrapper{display:flex;align-items:center;justify-content:center}.datePickerContainer{position:relative;padding-bottom:57px}.datePickerContainer .headerCalendar{height:56px;padding:20px}.datePickerContainer table thead tr:nth-child(2){color:#ccc}.datePickerContainer .headerCalendar .choose{font-size:20px;font-weight:bold;color:#000}.datePickerContainer .headerCalendar .close-button{margin:0;padding-top:8px;cursor:pointer;position:absolute;right:10px;top:0}.datePickerContainer .headerCalendar{height:56px;padding:16px 20px;position:relative}.datePickerContainer .showDatevalues{height:84px;width:100%;background-color:#f2f3f5;padding:15px;display:table}.datePickerContainer .showDatevalues .showStartdate,.datePickerContainer .showDatevalues .showEnddate{display:table-cell;text-align:center;position:relative}.datePickerContainer .showDatevalues .showStartdate .showStartYear{font-size:14px;font-weight:500;color:#677180;margin-right:79px}.datePickerContainer .showDatevalues .showStartdate .showStartMonth{font-size:24px;font-weight:bold;color:#000}.datePickerContainer .showDatevalues .showEnddate .showEndYear{font-size:14px;font-weight:500;color:#677180}.datePickerContainer .showDatevalues .showEnddate .showEndMonth{font-size:24px;font-weight:bold;color:#000}.datePickerContainer .daterangepicker{width:288px;position:relative;top:auto;left:auto;margin:0 auto;border:0;background:rgba(0,0,0,0)}.datePickerContainer .daterangepicker.drop-up:after{display:none}.datePickerContainer .daterangepicker.drop-up:before{display:none}.kore-chat-window .kore-action-sheet.hide .datePickerContainer .confirmBTN{opacity:0}.datePickerContainer .confirmBTN{position:absolute;z-index:100;height:54px;background:#009dab;bottom:0;width:100%;text-align:center;cursor:pointer;font-size:16px;font-weight:500;color:#fff;opacity:1;line-height:54px;transition:opacity 1.5s ease-in-out;-moz-transition:opacity 1.5s ease-in-out;-webkit-transition:opacity 1.5s ease-in-out}.darkTheme .datePickerContainer .confirmBTN{background:#0047cc}.datePickerContainer .daterangepicker .drp-calendar.right{padding:8px 8px 0 8px}.datePickerContainer .daterangepicker .drp-buttons{display:none}.datePickerContainer .applyBtn{outline:none;height:54px;display:none}.datePickerContainer .daterangepicker td.active,.datePickerContainer .daterangepicker td.active:hover{background-color:#e94848}.datePickerContainer .daterangepicker .calendar-table th,.datePickerContainer .daterangepicker .calendar-table td{border-radius:50%;height:32px}.datePickerContainer .date-picker-wrapper{font-size:15px}.datePickerContainer .date-picker-wrapper .month-wrapper table th{font-size:12px}.datePickerContainer .date-picker-wrapper .month-wrapper .day.toMonth.valid.checked.tmp.first-date-selected{background-color:#e94848 !important}.datePickerContainer .date-picker-wrapper .month-wrapper .day.toMonth.valid.tmp.checked.last-date-selected{background-color:#e94848 !important}.datePickerContainer .date-picker-wrapper .month-wrapper .day.toMonth.valid.checked.first-date-selected{background-color:#e94848 !important}.datePickerContainer .date-picker-wrapper .month-wrapper .day.toMonth.valid.checked.last-date-selected{background-color:#e94848 !important}.datePickerContainer .date-picker-wrapper .month-wrapper .day.toMonth.valid.real-today{background-color:#cdecfa;border-radius:50% !important;height:24px !important}.datePickerContainer .date-picker-wrapper .month-wrapper table .day.toMonth.valid{border-radius:50% !important;height:24px !important;width:26px !important}.datePickerContainer .date-picker-wrapper .month-wrapper table{width:100% !important;height:100% !important}.datePickerContainer .date-picker-wrapper .month-wrapper{text-align:center;width:225px;height:221px}.datePickerContainer .date-picker-wrapper table .caption .next,.date-picker-wrapper table .caption .prev{border-radius:50% !important;height:37px !important;width:35px !important;font-size:16px !important}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
var ___CSS_LOADER_URL_IMPORT_0___ = new URL(/* asset import */ __webpack_require__(25), __webpack_require__.b);
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
var ___CSS_LOADER_URL_REPLACEMENT_0___ = _node_modules_css_loader_dist_runtime_getUrl_js__WEBPACK_IMPORTED_MODULE_2___default()(___CSS_LOADER_URL_IMPORT_0___);
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".kore-chat-window .sdkAccount.accountBtn .accountIcon{background-image:url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ");background-size:100% 100%;width:21px;height:21px;margin:-4px;display:block}.kore-chat-window .kore-action-sheet .radioOptionsPickerContainer{height:415px;overflow-y:auto}.kore-chat-window .kore-action-sheet .radioOptionsPickerContainer .sdkFooterIcon.account{opacity:0}.kore-chat-window .kore-action-sheet .radioOptionsPickerContainer .radioOptionMenuHeader .closePicker{cursor:pointer;background:none;border:none;outline:none;position:absolute;top:21px;right:20px}.kore-chat-window .kore-action-sheet .radioOptionsPickerContainer .radioOptionMenuHeader .radioOptionHeading{width:160px;height:20px;font-size:20px;font-weight:bold;font-stretch:normal;font-style:normal;line-height:2;letter-spacing:normal;text-align:center;margin-left:17px;color:#000}.radioOptionMenuPicker{height:calc(100% - 109px);padding:0px 20px 0 20px;overflow-y:auto}.kore-chat-window .kore-action-sheet.hide .radioOptionsPickerContainer .confirmBTN{opacity:0;z-index:2}.kore-chat-window .kore-action-sheet .radioOptionsPickerContainer .confirmBTN{position:absolute;height:54px;background:#009dab;bottom:0;width:100%;text-align:center;cursor:pointer;font-size:14px;font-weight:500;color:#fff;opacity:1;line-height:54px;transition:opacity 1.5s ease-in-out;-moz-transition:opacity 1.5s ease-in-out;-webkit-transition:opacity 1.5s ease-in-out}.radioOptionMenuPicker .btnAccount{height:50px;background-color:#fff;border-radius:10px;padding-left:13px;cursor:pointer;margin-bottom:10px;display:table}.radioOptionMenuPicker .radioButton .btnAccount{position:relative;background-color:#fff}.radioOptionMenuPicker .btnAccount{display:block;cursor:pointer;user-select:none}.radioOptionMenuPicker .radioButton{width:61%}.radioOptionMenuPicker .radioButton .radioValue{display:table-cell}.radioOptionMenuPicker .radioButton .btnAccount input{position:absolute;opacity:0;cursor:pointer}.radioOptionMenuPicker .radioButton .btnAccount .checkmark{position:absolute;top:0;left:0;height:30px;width:30px;background-color:#eee;border-radius:50%;border:solid 1px #d8d8d8;background-color:#fff}.radioOptionMenuPicker .radioButton .btnAccount input:checked~.checkmark{background-color:#fff}.radioOptionMenuPicker .radioButton .btnAccount .checkmark:after{content:\"\";position:absolute;display:none}.radioOptionMenuPicker .radioButton .btnAccount input:checked~.checkmark:after{display:block}.radioOptionMenuPicker .radioButton .btnAccount .checkmark:after{top:7px;left:7px;width:14px;height:14px;border-radius:50%;background:#007ee5}.radioOptionMenuPicker .btnAccount .accountIcon{margin-right:15px}.radioOptionMenuPicker .btnAccount .radioOptionName{display:inline-block;overflow:hidden;white-space:nowrap;text-overflow:ellipsis;width:80%;position:relative;padding-left:40px;height:20px;font-size:15px;font-weight:bold;font-stretch:normal;font-style:normal;line-height:1.25;letter-spacing:-0.12px;color:#222}.radioOptionMenuPicker .btnAccount .radioOptionValue{padding-left:40px;margin-top:4px;overflow:hidden;white-space:nowrap;text-overflow:ellipsis;width:100%;height:19px;font-size:12px;font-weight:normal;font-stretch:normal;font-style:normal;line-height:1.58;letter-spacing:2px;color:#677180}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
var ___CSS_LOADER_URL_REPLACEMENT_0___ = _node_modules_css_loader_dist_runtime_getUrl_js__WEBPACK_IMPORTED_MODULE_2___default()(___CSS_LOADER_URL_IMPORT_0___);
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".kore-chat-window .sdkMenu.menuBtn .menuIcon{background-image:url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ");background-size:100% 100%;width:21px;height:21px;margin:-4px;display:block}.TaskPickerContainer{height:462px;overflow-y:auto}.TaskPickerContainer .taskMenuHeader .closeSheet{cursor:pointer;background:none;border:none;outline:none;position:absolute;top:21px;right:20px}.TaskPickerContainer .taskMenuHeader .taskHeading{line-height:2.5;margin-left:17px;font-size:20px;font-weight:bold;color:#000}.taskMenuPicker{height:calc(100% - 58px);padding:20px 30px;overflow-y:auto}.taskMenuPicker .btnTask{height:56px;box-shadow:0 1px 5px 0 rgba(179,186,200,.58);background-color:#fff;border-radius:10px;padding:8px;cursor:pointer;margin-bottom:10px}.taskMenuPicker .btnTask .taskIcon{margin-right:15px}.taskMenuPicker .btnTask .taskName{display:inline-block;overflow:hidden;white-space:nowrap;text-overflow:ellipsis;width:80%;position:relative;top:8px;color:#17151d;padding-left:10px}.taskMenuPicker .btnTask .displayIcon{width:100%}.taskMenuPicker .btnTask .imageIcon{width:30px;height:30px;margin:5px 3px;float:left}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
"use strict";
module.exports = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAADIAAAAyCAYAAAAeP4ixAAAABmJLR0QA/wD/AP+gvaeTAAAANElEQVRoge3WwQ0AIAzEsCv77wxLIFoke4I8kwAAqSS7O+KG1R0AAADP2HgAAPiOjQcABjrSpwMHOlg7MAAAAABJRU5ErkJggg==";
...
__webpack_require__.d(__webpack_exports__, {
  "KorePickersPlugin": () => (/* reexport */ korePickers)
});

;// CONCATENATED MODULE: ./src/libs/jquery-daterangepicker/jquery.daterangepicker.js
// jquery.daterangepicker.js
// author : Chunlong Liu
// license : MIT
// www.jszen.com
function installDateRangeFunctions($, moment) {
  'use strict';
...
/* harmony default export */ const jquery_daterangepicker = (installDateRangeFunctions);
...
// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js!./node_modules/postcss-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./src/libs/jquery-daterangepicker/daterangepicker.css
var daterangepicker = __webpack_require__(4274);
;// CONCATENATED MODULE: ./src/libs/jquery-daterangepicker/daterangepicker.css
...
var update = injectStylesIntoStyleTag_default()(daterangepicker/* default */.Z, options);




       /* harmony default export */ const jquery_daterangepicker_daterangepicker = (daterangepicker/* default */.Z && daterangepicker/* default.locals */.Z.locals ? daterangepicker/* default.locals */.Z.locals : undefined);

// EXTERNAL MODULE: ./node_modules/moment/moment.js
var moment = __webpack_require__(381);
var moment_default = /*#__PURE__*/__webpack_require__.n(moment);
// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js!./node_modules/postcss-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./src/templatemanager/templates/datePicker/datePicker.scss
var datePicker = __webpack_require__(80);
;// CONCATENATED MODULE: ./src/templatemanager/templates/datePicker/datePicker.scss
...
var datePicker_update = injectStylesIntoStyleTag_default()(datePicker/* default */.Z, datePicker_options);




       /* harmony default export */ const datePicker_datePicker = (datePicker/* default */.Z && datePicker/* default.locals */.Z.locals ? datePicker/* default.locals */.Z.locals : undefined);

;// CONCATENATED MODULE: ./src/templatemanager/templates/datePicker/datePicker.ts




var DatePickerTemplate = /** @class */ (function () {
    function DatePickerTemplate() {
        this.defaultDatePickerConfig = {
            alwaysOpen: true,
            singleMonth: true,
            showShortcuts: false,
            singleDate: true,
            showTopbar: false,
            format: 'DD-MM-YYYY',
            startDate: moment_default()(new Date()).format("DD-MM-YYYY"),
            endDate: (moment_default()(new Date()).add(3, 'M')).format("DD-MM-YYYY"),
            inline: true,
            container: '',
            appendTo: 'slider' // slider|| messageBubble
        };
    }
    DatePickerTemplate.prototype.renderMessage = function (msgData) {
        var _a, _b, _c;
        var me = this;
        var $ = me.hostInstance.$;
        if (((_c = (_b = (_a = msgData === null || msgData === void 0 ? void 0 : msgData.message[0]) === null || _a === void 0 ? void 0 : _a.component) === null || _b === void 0 ? void 0 : _b.payload) === null || _c === void 0 ? void 0 : _c.template_type) === "dateTemplate" && !msgData.fromHistory) {
    ...
    DatePickerTemplate.prototype.bindEvents = function () {
        var me = this;
        var chatWindowInstance = me.hostInstance;
        var $ = me.hostInstance.$;
        var startdateValue;
        $(me.messageHtml).off('click', ".confirmBTN").on('click', '.confirmBTN', function () {
            var startViewDate = moment_default()(startdateValue).format('MM-DD-YYYY') || moment_default()();
        ...
        me.daterangeInput.bind('datepicker-first-date-selected', function (event, obj) {
            var startYear = null;
            startdateValue = obj.date1;
            startYear = moment_default()(startdateValue).format("YYYY");
            var startDate = moment_default()(startdateValue).format("ddd,MMM DD");
    ...
    DatePickerTemplate.prototype.initiateDatePicker = function (msgData) {
        var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m;
        var me = this;
        var chatWindowInstance = me.hostInstance;
        var $ = me.hostInstance.$;
        jquery_daterangepicker($, (moment_default()));
        if (this.defaultDatePickerConfig.appendTo !== 'messageBubble') {
        ...
        if ((_c = (_b = (_a = msgData === null || msgData === void 0 ? void 0 : msgData.message[0]) === null || _a === void 0 ? void 0 : _a.component) === null || _b === void 0 ? void 0 : _b.payload) === null || _c === void 0 ? void 0 : _c.startDate) {
            datePickerConfig.startDate = msgData.message[0].component.payload.startDate;
        }
        if ((_f = (_e = (_d = msgData === null || msgData === void 0 ? void 0 : msgData.message[0]) === null || _d === void 0 ? void 0 : _d.component) === null || _e === void 0 ? void 0 : _e.payload) === null || _f === void 0 ? void 0 : _f.endDate) {
            datePickerConfig.endDate = msgData.message[0].component.payload.endDate;
        }
        if ((_j = (_h = (_g = msgData === null || msgData === void 0 ? void 0 : msgData.message[0]) === null || _g === void 0 ? void 0 : _g.component) === null || _h === void 0 ? void 0 : _h.payload) === null || _j === void 0 ? void 0 : _j.showdueDate) {
            datePickerConfig.showdueDate = msgData.message[0].component.payload.showdueDate;
        }
        if ((_m = (_l = (_k = msgData === null || msgData === void 0 ? void 0 : msgData.message[0]) === null || _k === void 0 ? void 0 : _k.component) === null || _l === void 0 ? void 0 : _l.payload) === null || _m === void 0 ? void 0 : _m.format) {
            datePickerConfig.format = msgData.message[0].component.payload.format;
            var givenFormat = msgData.message[0].component.payload.format;
            if (!msgData.message[0].component.payload.startDate) {
                datePickerConfig.startDate = moment_default()(new Date()).format(givenFormat);
            }
        }
    ...
    DatePickerTemplate.prototype.getTemplateString = function () {
    ...
    DatePickerTemplate.prototype.addClickEventCalender = function (msgData) {
        var me = this;
        var $ = me.hostInstance.$;
        $(me.messageHtml).find(".showStartdate .showStartMonth").html(moment_default()().format('ddd,MMM DD'));
...
/* harmony default export */ const templates_datePicker_datePicker = (DatePickerTemplate);

// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js!./node_modules/postcss-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./src/templatemanager/templates/dateRangePicker/dateRangePicker.scss
var dateRangePicker = __webpack_require__(379);
;// CONCATENATED MODULE: ./src/templatemanager/templates/dateRangePicker/dateRangePicker.scss
...
dateRangePicker_options.styleTagTransform = (styleTagTransform_default());
dateRangePicker_options.setAttributes = (setAttributesWithoutAttributes_default());

      dateRangePicker_options.insert = insertBySelector_default().bind(null, "head");
    
dateRangePicker_options.domAPI = (styleDomAPI_default());
dateRangePicker_options.insertStyleElement = (insertStyleElement_default());

var dateRangePicker_update = injectStylesIntoStyleTag_default()(dateRangePicker/* default */.Z, dateRangePicker_options);




       /* harmony default export */ const dateRangePicker_dateRangePicker = (dateRangePicker/* default */.Z && dateRangePicker/* default.locals */.Z.locals ? dateRangePicker/* default.locals */.Z.locals : undefined);

;// CONCATENATED MODULE: ./src/templatemanager/templates/dateRangePicker/dateRangePicker.ts




var DateRangePickerTemplate = /** @class */ (function () {
    function DateRangePickerTemplate() {
        this.defaultDateRangePickerConfig = {
            alwaysOpen: true,
            singleMonth: true,
            showShortcuts: false,
            showTopbar: false,
    ...
    DateRangePickerTemplate.prototype.renderMessage = function (msgData) {
        var _a, _b, _c;
        var me = this;
        var $ = me.hostInstance.$;
        if (((_c = (_b = (_a = msgData === null || msgData === void 0 ? void 0 : msgData.message[0]) === null || _a === void 0 ? void 0 : _a.component) === null || _b === void 0 ? void 0 : _b.payload) === null || _c === void 0 ? void 0 : _c.template_type) === "daterange" && !msgData.fromHistory) {
            me.messageHtml = $(me.getTemplateString('datePickerTemplate'));
            me.initiateDatePicker(msgData);
    ...
    DateRangePickerTemplate.prototype.bindEvents = function () {
        var me = this;
        var chatWindowInstance = me.hostInstance;
        var $ = me.hostInstance.$;
        var startdateValue;
        var enddateValue;
        var showEndDateValue;
        var showStartDateValue;
        $(me.messageHtml).off('click', ".confirmBTN").on('click', '.confirmBTN', function () {
            if ((showStartDateValue !== null) && (showEndDateValue == null)) {
                ...
                var startViewDate = moment_default()(startdateValue).format('MM-DD-YYYY') || moment_default()();
                var endViewDate = moment_default()(enddateValue).format('MM-DD-YYYY') || moment_default()();
        ...
        me.daterangeInput.bind('datepicker-change', function (event, obj) {
            var endYear;
            $(me.messageHtml).find('.showEnddate .showEndYear').css({ "opacity": "1" });
            enddateValue = obj.date2;
            endYear = moment_default()(enddateValue).format("YYYY");
            $(me.messageHtml).find('.showEnddate .showEndYear').html(endYear);
            var endDate = moment_default()(enddateValue).format("ddd,MMM DD");
            showEndDateValue = $(me.messageHtml).find(".showEnddate .showEndMonth").html(endDate);
        });
    };
    DateRangePickerTemplate.prototype.initiateDatePicker = function (msgData) {
        var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m;
        var me = this;
        var chatWindowInstance = me.hostInstance;
        var $ = me.hostInstance.$;
        ...
        if ((_m = (_l = (_k = msgData === null || msgData === void 0 ? void 0 : msgData.message[0]) === null || _k === void 0 ? void 0 : _k.component) === null || _l === void 0 ? void 0 : _l.payload) === null || _m === void 0 ? void 0 : _m.format) {
            ...
            if (!msgData.message[0].component.payload.endDate) {
                datePickerConfig.endDate = (moment_default()(new Date()).add(3, 'M')).format(givenFormat);
            }
        }
    ...
    DateRangePickerTemplate.prototype.getTemplateString = function () {
    ...
    DateRangePickerTemplate.prototype.bindDataToTemplate = function (msgData) {
        var me = this;
        var $ = me.hostInstance.$;
        $(me.messageHtml).find(".showStartdate .showStartMonth").html(moment_default()().format('ddd,MMM DD'));
        $(me.messageHtml).find('.showStartdate .showStartYear').html(new Date().getFullYear());
...
/* harmony default export */ const templates_dateRangePicker_dateRangePicker = (DateRangePickerTemplate);

// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js!./node_modules/postcss-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./src/templatemanager/templates/clockPicker/clockPicker.scss
var clockPicker = __webpack_require__(7742);
;// CONCATENATED MODULE: ./src/templatemanager/templates/clockPicker/clockPicker.scss
...
clockPicker_options.styleTagTransform = (styleTagTransform_default());
clockPicker_options.setAttributes = (setAttributesWithoutAttributes_default());

      clockPicker_options.insert = insertBySelector_default().bind(null, "head");
    
clockPicker_options.domAPI = (styleDomAPI_default());
clockPicker_options.insertStyleElement = (insertStyleElement_default());

var clockPicker_update = injectStylesIntoStyleTag_default()(clockPicker/* default */.Z, clockPicker_options);




       /* harmony default export */ const clockPicker_clockPicker = (clockPicker/* default */.Z && clockPicker/* default.locals */.Z.locals ? clockPicker/* default.locals */.Z.locals : undefined);

;// CONCATENATED MODULE: ./src/libs/jquery-clockpicker/jquery-clockpicker.js
...
function installClockPicker($) {
  ...
  ClockPicker.prototype.show = function (e) {
    ...
    $doc.on('click.clockpicker.' + this.id + ' focusin.clockpicker.' + this.id, function (e) {
      var target = $(e.target); //#kore made changes to hide slider only on click of close and confirm buttons
...
/* harmony default export */ const jquery_clockpicker = (installClockPicker); // }());
// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js!./node_modules/postcss-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./src/libs/jquery-clockpicker/jquery-clockpicker.css
var jquery_clockpicker_jquery_clockpicker = __webpack_require__(7444);
;// CONCATENATED MODULE: ./src/libs/jquery-clockpicker/jquery-clockpicker.css
...
var jquery_clockpicker_options = {};

jquery_clockpicker_options.styleTagTransform = (styleTagTransform_default());
jquery_clockpicker_options.setAttributes = (setAttributesWithoutAttributes_default());

      jquery_clockpicker_options.insert = insertBySelector_default().bind(null, "head");
    
jquery_clockpicker_options.domAPI = (styleDomAPI_default());
jquery_clockpicker_options.insertStyleElement = (insertStyleElement_default());

var jquery_clockpicker_update = injectStylesIntoStyleTag_default()(jquery_clockpicker_jquery_clockpicker/* default */.Z, jquery_clockpicker_options);




       /* harmony default export */ const libs_jquery_clockpicker_jquery_clockpicker = (jquery_clockpicker_jquery_clockpicker/* default */.Z && jquery_clockpicker_jquery_clockpicker/* default.locals */.Z.locals ? jquery_clockpicker_jquery_clockpicker/* default.locals */.Z.locals : undefined);

;// CONCATENATED MODULE: ./src/templatemanager/templates/clockPicker/clockPicker.ts


//import '../../../../../UI/libs/jquery-clockpicker.css';

var ClockPickerTemplate = /** @class */ (function () {
    function ClockPickerTemplate() {
        this.defaultClockerPickerConfig = {
            title: "",
            appendTo: 'slider'
        };
    }
    ClockPickerTemplate.prototype.renderMessage = function (msgData) {
        var _a, _b, _c;
        var me = this;
        var $ = me.hostInstance.$;
        if (((_c = (_b = (_a = msgData === null || msgData === void 0 ? void 0 : msgData.message[0]) === null || _a === void 0 ? void 0 : _a.component) === null || _b === void 0 ? void 0 : _b.payload) === null || _c === void 0 ? void 0 : _c.template_type) === "clockTemplate") {
    ...
    ClockPickerTemplate.prototype.bindEvents = function () {
        var me = this;
        var $ = me.hostInstance.$;
        var chatWindowInstance = me.hostInstance;
    ...
    ClockPickerTemplate.prototype.initiateClockPicker = function () {
        var me = this;
        var $ = me.hostInstance.$;
        var chatWindowInstance = me.hostInstance;
        jquery_clockpicker($);
    ...
    ClockPickerTemplate.prototype.getTemplateString = function () {
    ...
    ClockPickerTemplate.prototype.bindDataToTemplate = function (msgData) {
        var clockInput = this.clockPickerInputContainer;
        var me = this;
        var $ = me.hostInstance.$;
        var showAmorPm = $(me.messageHtml).find('#clockPickerInput').data('clockpicker');
    ...
    return ClockPickerTemplate;
}());
/* harmony default export */ const templates_clockPicker_clockPicker = (ClockPickerTemplate);

// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js!./node_modules/postcss-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./src/templatemanager/templates/radioOptionPicker/radioOptionPicker.scss
var radioOptionPicker = __webpack_require__(2234);
;// CONCATENATED MODULE: ./src/templatemanager/templates/radioOptionPicker/radioOptionPicker.scss
...
var radioOptionPicker_options = {};

radioOptionPicker_options.styleTagTransform = (styleTagTransform_default());
radioOptionPicker_options.setAttributes = (setAttributesWithoutAttributes_default());

      radioOptionPicker_options.insert = insertBySelector_default().bind(null, "head");
    
radioOptionPicker_options.domAPI = (styleDomAPI_default());
radioOptionPicker_options.insertStyleElement = (insertStyleElement_default());

var radioOptionPicker_update = injectStylesIntoStyleTag_default()(radioOptionPicker/* default */.Z, radioOptionPicker_options);




       /* harmony default export */ const radioOptionPicker_radioOptionPicker = (radioOptionPicker/* default */.Z && radioOptionPicker/* default.locals */.Z.locals ? radioOptionPicker/* default.locals */.Z.locals : undefined);

;// CONCATENATED MODULE: ./src/templatemanager/templates/radioOptionPicker/radioOptionPicker.ts

var RadioOptionPickerTemplate = /** @class */ (function () {
    function RadioOptionPickerTemplate() {
    ...
    RadioOptionPickerTemplate.prototype.renderMessage = function (msgData) {
        var _a, _b, _c;
        var me = this;
        var $ = me.hostInstance.$;
        if (((_c = (_b = (_a = msgData === null || msgData === void 0 ? void 0 : msgData.message[0]) === null || _a === void 0 ? void 0 : _a.component) === null || _b === void 0 ? void 0 : _b.payload) === null || _c === void 0 ? void 0 : _c.template_type) === "radioOptionTemplate" && !msgData.fromHistory) {
            me.messageHtml = $(me.getTemplateString());
            me.initiateRadioOptionPicker(msgData);
            me.bindEvents();
        }
    };
    RadioOptionPickerTemplate.prototype.bindEvents = function () {
        var me = this;
        var $ = me.hostInstance.$;
        var chatWindowInstance = me.hostInstance;
        var target;
        $(me.messageHtml).find(".btnAccount").click(function (event) {
    ...
    RadioOptionPickerTemplate.prototype.initiateRadioOptionPicker = function (msgData) {
        var me = this;
        var $ = me.hostInstance.$;
        var chatWindowInstance = me.hostInstance;
        // let accountData: any = me.getRadioOptions();
        var accountData = msgData.message[0].component.payload.radioOptions;
        chatWindowInstance.bottomSliderAction('show', me.messageHtml);
    ...
    RadioOptionPickerTemplate.prototype.getTemplateString = function () {
    ...
    RadioOptionPickerTemplate.prototype.getradioOptionsPickerTemplate = function (radioOptionConfig) {
        var me = this;
        var $ = me.hostInstance.$;
        var $radioOptionsContent = $('<div class="radioOptionMenuPicker"></div>');
        radioOptionConfig.forEach(function (radioOption) {
    ...
    return RadioOptionPickerTemplate;
}());
/* harmony default export */ const templates_radioOptionPicker_radioOptionPicker = (RadioOptionPickerTemplate);

// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js!./node_modules/postcss-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./src/templatemanager/templates/taskPickerTemplate/taskPickerTemplate.scss
var taskPickerTemplate = __webpack_require__(5022);
;// CONCATENATED MODULE: ./src/templatemanager/templates/taskPickerTemplate/taskPickerTemplate.scss
...
var taskPickerTemplate_options = {};

taskPickerTemplate_options.styleTagTransform = (styleTagTransform_default());
taskPickerTemplate_options.setAttributes = (setAttributesWithoutAttributes_default());

      taskPickerTemplate_options.insert = insertBySelector_default().bind(null, "head");
    
taskPickerTemplate_options.domAPI = (styleDomAPI_default());
taskPickerTemplate_options.insertStyleElement = (insertStyleElement_default());

var taskPickerTemplate_update = injectStylesIntoStyleTag_default()(taskPickerTemplate/* default */.Z, taskPickerTemplate_options);




       /* harmony default export */ const taskPickerTemplate_taskPickerTemplate = (taskPickerTemplate/* default */.Z && taskPickerTemplate/* default.locals */.Z.locals ? taskPickerTemplate/* default.locals */.Z.locals : undefined);

;// CONCATENATED MODULE: ./src/templatemanager/templates/taskPickerTemplate/taskPickerTemplate.ts

var TaskPickerTemplate = /** @class */ (function () {
    function TaskPickerTemplate() {
        this.getTaskMenuItems = function () {
    ...
    TaskPickerTemplate.prototype.renderMessage = function (msgData) {
        var _a, _b, _c;
        var me = this;
        var $ = me.hostInstance.$;
        if (((_c = (_b = (_a = msgData === null || msgData === void 0 ? void 0 : msgData.message[0]) === null || _a === void 0 ? void 0 : _a.component) === null || _b === void 0 ? void 0 : _b.payload) === null || _c === void 0 ? void 0 : _c.template_type) === "taskPickerTemplate" && !msgData.fromHistory) {
            me.messageHtml = $(me.getTemplateString());
            me.initiateTaskPicker(msgData);
            me.bindEvents();
        }
    };
    TaskPickerTemplate.prototype.bindEvents = function () {
        var me = this;
        var $ = me.hostInstance.$;
        var chatWindowInstance = me.hostInstance;
        $(me.messageHtml).find(".btnTask").click(function (e) {
    ...
    TaskPickerTemplate.prototype.initiateTaskPicker = function (msgData) {
        var me = this;
        var $ = me.hostInstance.$;
        var chatWindowInstance = me.hostInstance;
        // let accountData: any = me.getTaskMenuItems();
        var accountData = msgData.message[0].component.payload.tasks;
        chatWindowInstance.bottomSliderAction('show', me.messageHtml);
    ...
    TaskPickerTemplate.prototype.getTemplateString = function () {
    ...
    TaskPickerTemplate.prototype.getTaskPickerOptions = function (taskPickerConfig) {
        var me = this;
        var $ = me.hostInstance.$;
        var $taskContent = $('<div class="taskMenuPicker"></div>');
        taskPickerConfig.forEach(function (task) {
...
/* harmony default export */ const templates_taskPickerTemplate_taskPickerTemplate = (TaskPickerTemplate);

;// CONCATENATED MODULE: ./src/plugins/korePickers.ts
...
var KorePickersPlugin = /** @class */ (function () {
    function KorePickersPlugin(pickerConfig) {
        var _this = this;
        this.name = 'KorePickersPlugin';
        this.config = {
            clock: {
                showOnFooter: false,
                text: "display",
        ...
        this.getDatePickerTemplateString = function () {
        ...
        this.getDateRangePickerTemplateString = function () {
        ...
        this.getTaskPickerTemplateString = function () {
        ...
        this.getRadioOptionPickerTemplateString = function () {
        ...
        this.showClockPicker = function (options) {
            var me = _this;
            if (options) {
                me.config.clock = __assign(__assign({}, me.config.clock), options);
            }
            var $ = me.hostInstance.$;
            var chatWindowInstance = me.hostInstance;
            var tempMessageData = {
        ...
        this.showDatePicker = function (options) {
            var me = _this;
            if (options) {
                me.config.date = __assign(__assign({}, me.config.date), options);
            }
            var $ = me.hostInstance.$;
            var chatWindowInstance = me.hostInstance;
            var tempMessageData = {
        ...
        this.showDateRangePicker = function (options) {
            var me = _this;
            if (options) {
                me.config.daterange = __assign(__assign({}, me.config.daterange), options);
            }
            var $ = me.hostInstance.$;
            var chatWindowInstance = me.hostInstance;
            var tempMessageData = {
        ...
        this.showRadioOptionPicker = function (options) {
            var me = _this;
            if (options) {
        ...
        this.showTaskPicker = function (options) {
            var me = _this;
            if (options) {
    ...
    KorePickersPlugin.prototype.onHostCreate = function () {
        var me = this;
    ...
    KorePickersPlugin.prototype.onInit = function () {
        var me = this;
        me.installPickerTemplates();
        me.appendPickersToChatWindow();
    };
    KorePickersPlugin.prototype.installPickerTemplates = function () {
        var me = this;
        var templateManager = me.hostInstance.templateManager;
        templateManager.installTemplate(new templates_datePicker_datePicker());
        templateManager.installTemplate(new templates_dateRangePicker_dateRangePicker());
        templateManager.installTemplate(new templates_clockPicker_clockPicker());
        templateManager.installTemplate(new templates_radioOptionPicker_radioOptionPicker());
        templateManager.installTemplate(new templates_taskPickerTemplate_taskPickerTemplate());
    };
    KorePickersPlugin.prototype.appendPickersToChatWindow = function () {
        var _a, _b, _c, _d, _e, _f, _g, _h, _j;
        var me = this;
        var $ = me.hostInstance.$;
        var chatWindowInstance = me.hostInstance;
        if (this.config && ((_b = (_a = this.config) === null || _a === void 0 ? void 0 : _a.clock) === null || _b === void 0 ? void 0 : _b.showOnFooter)) {
        ...
        if (this.config && ((_d = (_c = this.config) === null || _c === void 0 ? void 0 : _c.date) === null || _d === void 0 ? void 0 : _d.showOnFooter)) {
            me.pickerHTML = $(me.getDatePickerTemplateString());
            me.appendPickerHTMLtoChatWindowFooter(me.pickerHTML);
            me.bindEvents(me.pickerHTML);
        }
        if (this.config && ((_f = (_e = this.config) === null || _e === void 0 ? void 0 : _e.daterange) === null || _f === void 0 ? void 0 : _f.showOnFooter)) {
            me.pickerHTML = $(me.getDateRangePickerTemplateString());
            me.appendPickerHTMLtoChatWindowFooter(me.pickerHTML);
            me.bindEvents(me.pickerHTML);
        }
        if (this.config && ((_h = (_g = this.config) === null || _g === void 0 ? void 0 : _g.task) === null || _h === void 0 ? void 0 : _h.showOnFooter)) {
            me.pickerHTML = $(me.getTaskPickerTemplateString());
            me.appendPickerHTMLtoChatWindowFooter(me.pickerHTML);
            me.bindEvents(me.pickerHTML);
        }
        if (this.config && ((_j = this.config) === null || _j === void 0 ? void 0 : _j.radiooption.showOnFooter)) {
            me.pickerHTML = $(me.getRadioOptionPickerTemplateString());
            me.appendPickerHTMLtoChatWindowFooter(me.pickerHTML);
            me.bindEvents(me.pickerHTML);
        }
    };
    KorePickersPlugin.prototype.appendPickerHTMLtoChatWindowFooter = function (pickerHTML) {
        var me = this;
        var chatWindowInstance = me.hostInstance;
        var _chatContainer = chatWindowInstance.chatEle;
        _chatContainer.find('.kore-chat-footer .footerContainer').append(pickerHTML);
    };
    KorePickersPlugin.prototype.getClockPickerTemplateString = function () {
    ...
    KorePickersPlugin.prototype.bindEvents = function (element) {
        var _this = this;
        var me = this;
        var $ = me.hostInstance.$;
        var chatWindowInstance = me.hostInstance;
        $(element).on('click', '.sdkClock.clockBtn', function (event) {
            _this.showClockPicker();
        });
        ...
        $(element).on('click', '.sdkRangeCalender.calenderBtn', function (event) {
            _this.showDateRangePicker();
        });
        $(element).on('click', '.sdkAccount.accountBtn', function (event) {
            _this.showRadioOptionPicker();
        });
        $(element).on('click', '.sdkMenu.menuBtn', function (event) {
            _this.showTaskPicker();
        });
    };
    KorePickersPlugin.prototype.extend = function (target, source) {
        var me = this;
    ...
    return KorePickersPlugin;
}());
/* harmony default export */ const korePickers = (KorePickersPlugin);
// export default {
//     name: "KorePickersPlugin",
//     plugin: KorePickersPlugin
// }

;// CONCATENATED MODULE: ./src/index_plugins/korepicker_umd.ts
