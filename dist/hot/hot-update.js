 ...
 <div class="actionSheetContainer"></div>\
    ...
    chatWindow.prototype.bindEvents = function () {
        ...
        _chatContainer.on('click', 'li a', function (e) {
            ...
            var a_link = targetEle.attr('href');
            var _trgt = targetEle.attr('target');
            var msgDataText = $(targetEle).closest('span.simpleMsg').attr('msgData') || '';
            var msgData;
            if (msgDataText) {
                try {
    ...
    chatWindow.prototype.historyLoadingComplete = function () {
        ...
        setTimeout(function (me) {
            ...
            if ($(_this.paginatedScrollMsgDiv).find('.prev-message-list li.previousMessage').length > 0 && bot.previousHistoryLoading) {
                var paginatedLi = $(_this.paginatedScrollMsgDiv).find('.prev-message-list li.previousMessage');
                ...
                var _existingLi = $(_this.paginatedScrollMsgDiv).find('.prev-message-list li.previousMessage');
                $(_this.paginatedScrollMsgDiv).find('.prev-message-list li.previousMessage').insertBefore(_chatContainer.find('.chat-container li:first'));
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("719dd065f560fa56c21b")
/******/ })();
/******/ 
/******/ }
)
